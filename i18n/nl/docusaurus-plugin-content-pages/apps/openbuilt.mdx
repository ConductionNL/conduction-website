...
<Section spacing="default" background="tinted">
  <SectionHead
    ...
    title="De apps die OpenBuilt aan elkaar knoopt."
    align="stack"
  />
  <PairRow>
    <PairCard
...
<CtaBanner
  ...
  lede={<>OpenBuilt geeft niet-technische gebruikers de bouwblokken om eigen apps samen te stellen. Schema's, koppelvlakken, workflows, allemaal in handen van wie het probleem kent.</>}
  primaryCta={{label: 'Installeer uit de app store', href: '/install'}}
