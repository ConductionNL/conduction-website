...
<Section spacing="default">
  <SectionHead
    ...
    align="stack"
    lede="OpenKlant is het Common Ground klantcontact-register. We verpakken het als Nextcloud-installeerbare sidecar. Je installeert de app, de upstream-container draait naast Nextcloud, en de ZGW-API's zijn bereikbaar vanuit Integriq. Dezelfde upstream, minder DevOps."
  />
</Section>
...
<CtaBanner
  ...
  lede={<>Installeer uit de Nextcloud-app-store. Combineer met Integriq om ZGW-calls te routeren. Combineer met Dossiq om workflows op klantcontact-events te draaien.</>}
  primaryCta={{label: 'Installeer uit de app store', href: '/install'}}
