...
<CtaBanner
  ...
  lede={<>Installeer uit de Nextcloud-app-store. Koppel lokale modellen aan AI Companion. Drijf samenvattingsflows vanuit Integriq. Houd elke prompt op je eigen hardware.</>}
  primaryCta={{label: 'Installeer uit de app store', href: '/install'}}
