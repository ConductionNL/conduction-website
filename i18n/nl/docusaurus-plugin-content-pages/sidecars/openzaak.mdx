...
<DetailHero
  ...
  tertiaryCta={{label: 'Bekijk op GitHub', href: 'https://codeberg.org/Conduction/openzaak'}}
...
<Section spacing="default">
  <SectionHead
    ...
    align="stack"
    lede="OpenZaak is de Common Ground zaakafhandeling-API. We verpakken het als Nextcloud-installeerbare sidecar. Je installeert de app, de upstream-container draait naast Nextcloud, en de ZGW-endpoints zijn bereikbaar vanuit Integriq. Dezelfde upstream, minder DevOps."
  />
</Section>
...
<CtaBanner
  ...
  lede={<>Installeer uit de Nextcloud-app-store. Route ZGW-calls via Integriq. Stuur zaken door Dossiq-workflows.</>}
  primaryCta={{label: 'Installeer uit de app store', href: '/install'}}
