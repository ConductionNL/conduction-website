...
<DetailHero
  ...
  tertiaryCta={{label: 'Bekijk op GitHub', href: 'https://codeberg.org/Conduction/n8n-nextcloud'}}
...
<CtaBanner
  ...
  lede={<>Installeer uit de Nextcloud-app-store. Verbind met OpenRegister-rijen. Trigger workflows vanuit OpenConnector-events. Toon resultaten in LaunchPad.</>}
  primaryCta={{label: 'Installeer uit de app store', href: '/install'}}
