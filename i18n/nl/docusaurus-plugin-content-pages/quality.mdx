...
Elke Conduction-app staat publiek op GitHub onder de [ConductionNL](https://codeberg.org/Conduction)-organisatie. De herbruikbare [`Quality`-workflow](https://codeberg.org/Conduction/.github/src/branch/main/.github/workflows/quality.yml) — één keer gedefinieerd in de `.github`-repo en aangeroepen door elke app — draait dezelfde gate-stack op elke pull request: vier parallelle kwaliteitsmatrices, daarna een gated test-fase, daarna rapportage + een Software Bill of Materials op beschermde branches.
