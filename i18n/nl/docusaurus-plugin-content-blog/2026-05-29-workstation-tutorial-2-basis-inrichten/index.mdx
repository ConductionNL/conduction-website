...
Onze canonical [workstation-setup.md](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md) beschrijft het Windows + WSL2-pad; de macOS- en Linux-varianten hierboven zijn de vertaling die de meeste teams gebruiken. Loop je tegen iets aan dat niet één-op-één vertaalt, stuur dan onderaan even een berichtje via [Mail ons](mailto:info@conduction.nl).
...
Daarmee dek je de verplichte + aanbevolen set voor een Conduction-project. Zie [workstation-setup.md](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md#4-install-vs-code-extensions) voor de optionele.
...
> **Waarom Node 20, niet de nieuwste?** Docusaurus 3.x en de OpenSpec-CLI willen allebei Node 20+, en onze canonical [workstation-setup.md](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md) installeert specifiek Node 20. Blijf bij 20 LTS tot je een reden hebt om dat niet te doen.
...
Dit is de condensed walkthrough. De volledige versie, met elke troubleshooting-case en diepere achtergrond, staat in [Codeberg Authentication Setup](https://github.com/ConductionNL/.github/blob/main/docs/claude/codeberg-auth-setup.md) in de `.github` repo. Lees die als hieronder iets niet werkt.
