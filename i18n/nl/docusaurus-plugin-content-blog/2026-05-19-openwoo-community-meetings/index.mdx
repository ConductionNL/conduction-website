...
- [Woo-register opzetten in OpenRegister](/nl/academy/woo-set-up-register) — start hier als je net begint; importeert het canonieke Woo-register met alle TOOI-categorieën in tien minuten.
- [Woo-bestanden uploaden](/nl/academy/woo-upload-files) — vervolgtutorial; voeg PDF-bijlagen toe aan publicaties.
