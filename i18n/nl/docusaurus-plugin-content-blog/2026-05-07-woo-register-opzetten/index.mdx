...
tags: [Woo, OpenRegister, Publicaties, TOOI, Open data, Tutorial series]
...
De <a href="/nl/academy/woo-upload-files">vervolgtutorial over bestanden uploaden</a> bouwt hierop voort.

<Prerequisites title="Wat je nodig hebt">
  <PrerequisiteItem>Een draaiende Nextcloud met OpenRegister geïnstalleerd. Heb je dat nog niet, volg dan eerst <a href="/nl/academy/run-nextcloud-locally">Nextcloud lokaal draaien met Docker</a>.</PrerequisiteItem>
...
```
https://codeberg.org/Conduction/woo-website/raw/branch/main/website/static/oas/woo_register.json
```
...
curl -u admin:admin \
  ...
  -d '{
    "url": "https://codeberg.org/Conduction/woo-website/raw/branch/main/website/static/oas/woo_register.json"
  }'
```
...
In de [vervolgtutorial koppel je bestanden aan deze publicatie](/nl/academy/woo-upload-files), van enkele PDF's tot grote videobestanden in chunks.
