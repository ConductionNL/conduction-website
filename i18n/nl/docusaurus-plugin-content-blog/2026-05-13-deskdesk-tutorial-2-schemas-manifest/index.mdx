...
<Prerequisites title="Waar je moet staan">
  ...
  <PrerequisiteItem>Een lokale clone van <a href="https://codeberg.org/Conduction/deskdesk">Conduction/deskdesk</a> op je schijf en een werkende <code>npm run build</code>.</PrerequisiteItem>
</Prerequisites>
