...
tags: [MKB, Migratie, OpenCatalogi, LaunchPad]
apps: [opencatalogi, launchpad]
durationMinutes: 6
---
...
Nextcloud opgezet op de bestaande on-prem hardware en OpenRegister, OpenCatalogi, OpenConnector, DocuDesk en LaunchPad uit de app store geïnstalleerd. De data gemigreerd met twee OpenConnector-flows. Het team getraind in twee halve-dag-sessies.
