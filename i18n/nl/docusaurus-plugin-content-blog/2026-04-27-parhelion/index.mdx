...
Nextcloud opgezet op de bestaande on-prem hardware en OpenRegister, OpenCatalogi, Integriq, Filinq en LaunchPad uit de app store geïnstalleerd. De data gemigreerd met twee Integriq-flows. Het team getraind in twee halve-dag-sessies.
