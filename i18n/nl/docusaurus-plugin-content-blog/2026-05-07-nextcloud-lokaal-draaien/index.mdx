...
> **Dagelijkse developer-setup?** Werk je door de [Conduction Workstation Setup-leerlijn](/nl/academy/workstation-tutorial-1-wat-installeer-je) heen, dan pakt [Deel 5](/nl/academy/workstation-tutorial-5-nextcloud-lokaal) op waar deze tutorial eindigt — met de Conduction `apps-extra`-werkmap-flow (Docker-profielen, `clean-env.sh`, reset-or-keep-state) die de standalone compose hieronder niet behandelt.
