...
> **Dagelijkse developer-setup?** Deze standalone tutorial is de beginner-vriendelijke route. Voor échte Conduction-app-ontwikkeling beschrijft [Deel 5](/nl/academy/workstation-tutorial-5-nextcloud-lokaal) van de [Workstation Setup-leerlijn](/nl/academy/workstation-tutorial-1-wat-installeer-je) de `nextcloud-docker-dev` + `apps-extra/`-flow — waarbij je Conduction-apps cloned (niet installeert vanuit de app store) zodat je lokale code-wijzigingen meteen in Nextcloud verschijnen.
