...
- **App-broncode:** [`ConductionNL/deskdesk`](https://codeberg.org/Conduction/deskdesk), de daadwerkelijke Nextcloud-app die je vanuit de template forkt.
- **Tutorial-broncode:** [`ConductionNL/conduction-website`](https://codeberg.org/Conduction/conduction-website), de post die je nu leest.
...
[`ConductionNL/nextcloud-app-template`](https://codeberg.org/Conduction/nextcloud-app-template) is een GitHub *repository template*. De knop "Use this template" geeft je een verse repo met de volledige starter kit: Vue 2 + Pinia-frontend, PHP-backend, OpenRegister-bedrading, kwaliteitspijplijn, OpenSpec-scaffolding, GitHub Actions.
