...
<Prerequisites title="Wat je nodig hebt">
  <PrerequisiteItem>Een werkende installatie van <a href="https://docs.claude.com/en/docs/claude-code/overview">Claude Code</a> op je laptop. Zo niet, doe eerst de <a href="https://codeberg.org/Conduction/.github/src/branch/main/docs/claude/workstation-setup.md">Workstation Setup</a>.</PrerequisiteItem>
