...
<Prerequisites title="Wat je nodig hebt">
  <PrerequisiteItem>Een werkende installatie van <a href="https://docs.claude.com/en/docs/claude-code/overview">Claude Code</a> op je laptop. Zo niet, volg eerst de <a href="/nl/academy/workstation-tutorial-1-wat-installeer-je">Workstation Setup-leerlijn</a>.</PrerequisiteItem>
