...
Onze projecten hebben allemaal dezelfde OpenSpec-mappenstructuur. Eén keer kijken in [openregister/openspec](https://codeberg.org/Conduction/openregister/tree/development/openspec) geeft je een goed beeld:
