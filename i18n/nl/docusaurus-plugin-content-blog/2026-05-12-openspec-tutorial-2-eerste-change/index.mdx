...
<NextSteps title="Volgende stap" lede="Je eerste change staat. Een paar logische vervolgstappen:">
  <NextStep
    title="Deel 3 — Retrofit een bestaande codebase"
    href="/nl/academy/openspec-tutorial-3-retrofit"
    description="Breng de OpenSpec-conventie naar een app die ouder is: audit met /opsx-coverage-scan, annoteer Bucket 1, draft ontbrekende REQs met /opsx-reverse-spec."
  />
  <NextStep
