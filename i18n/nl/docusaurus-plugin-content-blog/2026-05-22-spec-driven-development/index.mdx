...
{() => {
  ...
  return (
  <div style={{ background: 'var(--conduction-color-surface-subtle)', borderRadius: '12px', padding: '0.5rem 0', margin: '1.5rem 0' }}>
    <cn-domain-tree>
...
{() => {
  require('@conduction/docusaurus-preset/diagrams');
  return (
  <div style={{ background: 'var(--conduction-color-surface-subtle)', borderRadius: '12px', padding: '1rem', margin: '1.5rem 0', overflowX: 'auto' }}>
    <cn-pipeline>
