...
- Het **manifest** is `src/manifest.json`. Het is een JSON-document gevalideerd door een schema (`https://codeberg.org/Conduction/nextcloud-vue/raw/branch/main/src/schemas/app-manifest-v2.schema.json`, op dit moment versie 2.7.0). Het beschrijft navigatie-entries, routes, en wat elke pagina rendert. Het heeft op zichzelf geen runtime-gedrag.
