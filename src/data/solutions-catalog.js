...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    shortTitle: 'Archive',
    outcome: <>OpenRegister stores your live data, Integriq moves records on schedule to your e-Depot. NEN-2082 mapped, eIDAS-AdES sealed.</>,
  ...
  },
  {
    ...
    outcome: <>Privacy-by-design pipeline on <span className="next-blue">Nextcloud</span>. Filinq and OpenRegister detect and redact records and documents before they leave your organization. Presidio under the hood, GDPR-explainable.</>,
  ...
  },
  {
    ...
    builtOn: ['Anonymiq', 'Filinq', 'OpenRegister', 'OpenCatalogi'], goals: ['compliance'], status: 'beta',
    icon: <svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M5 21v-2a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v2"/><path d="M9 8h6"/></svg>,
  },
  {
    slug: 'mkb-workspace',
