...
const PARTNERS_DATA = [
  ...
  // --------------------------------------------------------------
  {
    ...
    summaryEn: <>Digital agency. Builds accessible websites and web apps for municipalities and government organisations, focused on WCAG 2.2 AA and NLDS. Delivers the Conduction OpenWoo solution on OpenCatalogi, OpenRegister, and OpenConnector.</>,
    summaryNl: <>Digital agency. Bouwt toegankelijke websites en webapplicaties voor gemeenten en overheidsorganisaties, met focus op WCAG 2.2 AA en NLDS. Levert de Conduction Woo-solution op OpenCatalogi, OpenRegister en OpenConnector.</>,
