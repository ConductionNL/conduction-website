...
/* INTERIM site copy of the preset's AppCrossLinks (see plugins/apps-registry-interim.js):
   renders the per-app `description` from the interim registry under the app name.
    ...
    <div className={styles.card} aria-labelledby={tagId}>
      <div className={styles.head}>
        ...
        <div>
          ...
          {reg.description && (
            <p style={{margin: '4px 0 0', fontSize: '0.85rem', color: 'var(--ifm-color-emphasis-700)', lineHeight: 1.45}}>
              {reg.description}
            </p>
          )}
        </div>
