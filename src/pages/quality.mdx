  ...
  <div style={{
    ...
    <div style={{display: 'flex', flexDirection: 'column', gap: 8}}>
      ...
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 11, color: 'rgba(255,255,255,0.85)'}}>
        ...
        <span style={{background: 'var(--c-mint-500)', color: 'var(--conduction-color-text-strong)', padding: '2px 8px', borderRadius: 3, fontWeight: 700, fontSize: 9, letterSpacing: '0.05em'}}>CLEAN</span>
      </div>
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 11, color: 'rgba(255,255,255,0.85)'}}>
        <span>GitHub PR #482 · code + security review</span>
        <span style={{background: 'var(--c-mint-500)', color: 'var(--conduction-color-text-strong)', padding: '2px 8px', borderRadius: 3, fontWeight: 700, fontSize: 9, letterSpacing: '0.05em'}}>MERGED</span>
      </div>
    </div>
  </div>
);
    ...
    },
    {
      ...
      panel: (
        <div style={{padding: 20, background: 'var(--conduction-color-surface-subtle)', borderRadius: 8, minHeight: 280, fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 11, color: 'var(--conduction-color-text-strong)'}}>
          <div style={{fontWeight: 700, marginBottom: 12, color: 'var(--conduction-color-text-body)'}}>docs.conduction.nl — handbook sections</div>
    ...
    },
    {
      ...
      panel: (
        <div style={{padding: 20, background: 'var(--conduction-color-surface-subtle)', borderRadius: 8, minHeight: 280, fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 12, color: 'var(--conduction-color-text-strong)'}}>
          <div style={{fontWeight: 700, marginBottom: 12, color: 'var(--conduction-color-text-body)'}}>pentest-tools.com — last scan</div>
          {[
...
<div style={{borderBottom: '2px solid var(--c-cobalt-100)', paddingBottom: 24, marginBottom: 28}}>
  ...
  <dl style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '14px 28px', margin: 0}}>
    ...
    <div>
      <dt style={{fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--conduction-color-text-muted)', marginBottom: 4}}>Adopted</dt>
      <dd style={{margin: 0, fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 13, color: 'var(--conduction-color-text-strong)', fontWeight: 600}}>January 2026</dd>
    </div>
    <div>
      <dt style={{fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--conduction-color-text-muted)', marginBottom: 4}}>Certificates</dt>
    ...
    <div>
      <dt style={{fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--conduction-color-text-muted)', marginBottom: 4}}>Next review</dt>
      <dd style={{margin: 0, fontFamily: 'var(--conduction-typography-font-family-code)', fontSize: 13, color: 'var(--conduction-color-text-strong)', fontWeight: 600}}>January 2027</dd>
    </div>
  </dl>
</div>
