...
<DetailHero
  ...
  tertiaryCta={{label: 'View on GitHub', href: 'https://codeberg.org/Conduction/app-versions'}}
...
<CtaBanner
  ...
  secondaryCta={{label: 'View on GitHub', href: 'https://codeberg.org/Conduction/app-versions'}}
/>
