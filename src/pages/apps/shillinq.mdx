...
<DetailHero
  ...
  secondaryCta={{label: 'Read the docs', href: 'https://shillinq.conduction.nl'}}
  tertiaryCta={{label: 'View on GitHub', href: 'https://codeberg.org/Conduction/shillinq'}}
/>
  ...
  <div style={{display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 320px', gap: 'var(--space-8)', alignItems: 'start'}}>
    <div style={{minWidth: 0}}>
      <SectionHead
        ...
        align="stack"
        lede="Shillinq handles invoicing, contracts and procurement in one app. No separate accounting software, no separate CRM, no standalone procurement portal. Everything lives in OpenRegister, so the figures in LaunchPad and reports in OpenCatalogi stay in sync."
      />
      <FeatureList>
        <FeatureItem
        ...
        >
          Generate invoices from templates. Send them straight from Nextcloud Mail. Track outstanding amounts in LaunchPad.
        </FeatureItem>
        <FeatureItem
