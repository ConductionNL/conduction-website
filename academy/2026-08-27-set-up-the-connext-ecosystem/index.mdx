...
apps: [openregister, opencatalogi, portaliq, integriq, filinq, launchpad, pipelinq, shillinq, hermiq]
durationMinutes: 20
---
...
```
==> apps present: filinq hermiq integriq launchpad nldesign opencatalogi
    openregister pipelinq portaliq shillinq zaakafhandelapp
```
