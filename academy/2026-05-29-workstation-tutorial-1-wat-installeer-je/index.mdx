...
If you've set up a Conduction workstation before and just need the commands in order on a fresh machine, the **[Quick Setup cheat-sheet](https://github.com/ConductionNL/.github/blob/main/docs/claude/quick-setup.md)** in the `.github` repo has prerequisites (Windows + WSL, native Linux, **or** macOS), the repos to clone, the install commands in order, and a validation step — on one page. This series is the *narrative* walkthrough for first-timers; the cheat-sheet is the *condensed* recipe for re-setups.
:::
...
If you hit any other issue, the [canonical workstation-setup doc](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md) is the source of truth.

## What this series follows

This series is a guided walk through the canonical [`workstation-setup.md`](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md) in the Conduction `.github` repo. That doc is Windows + WSL2 + Docker Desktop + VS Code. macOS and native Linux aren't covered there — if you go that route, you're adapting from the same concepts.
