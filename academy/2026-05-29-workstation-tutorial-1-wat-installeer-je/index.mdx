...
If you've set up a Conduction workstation before and just need the commands in order on a fresh machine, the **[Quick Setup cheat-sheet](https://codeberg.org/Conduction/.github/src/branch/main/docs/claude/quick-setup.md)** in the `.github` repo has prerequisites (Windows + WSL **or** native Linux), the repos to clone, the install commands in order, and a validation step — on one page. This series is the *narrative* walkthrough for first-timers; the cheat-sheet is the *condensed* recipe for re-setups.
:::
