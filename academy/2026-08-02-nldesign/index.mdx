---
slug: nldesign
title: "NLDesign: the NL Design System as a drop-in Nextcloud theme"
contentType: webinar
heroIcon: palette
authors: [conduction]
date: 2026-08-02
summary: A walk-through of NLDesign, which brings the official NL Design System tokens into Nextcloud. Pick your organisation's house style from a list of pre-built themes, fine-tune tokens in the editor, and every Conduction app picks it up without being branded separately.
tags: [NLDesign, NL Design System, Theming, Accessibility, Design tokens]
apps: [nldesign]
durationMinutes: 40
---
...
<NextSteps>
  <NextStep
    title="NLDesign on the app page"
    href="/apps/nldesign"
...
- Source and issues: [NLDesign on Codeberg](https://codeberg.org/Conduction/nldesign)
