...
This part deepens the *manifest* surface. [Part 6 — Integrate](/academy/deskdesk-tutorial-6-integrate) widens the app to *other systems* (cross-register reads, OpenConnector sources, webhooks). Both build directly on Part 4 — take them in either order, or pick whichever your next app needs first.
:::
...
<NextSteps>
  <NextStep
    ...
    description="The final part: connect your app to the rest of the workspace. Cross-register reads, OpenConnector sources, and a two-way webhook sync — three integration patterns layered from least to most invasive."
  />
  <NextStep
