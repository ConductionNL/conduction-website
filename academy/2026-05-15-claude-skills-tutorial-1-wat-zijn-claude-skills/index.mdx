...
<Prerequisites title="What you need">
  <PrerequisiteItem>A working installation of <a href="https://docs.claude.com/en/docs/claude-code/overview">Claude Code</a> on your laptop. If not, do the <a href="https://codeberg.org/Conduction/.github/src/branch/main/docs/claude/workstation-setup.md">Workstation Setup</a> first.</PrerequisiteItem>
