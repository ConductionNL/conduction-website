...
<Prerequisites title="What you need">
  <PrerequisiteItem>A working installation of <a href="https://docs.claude.com/en/docs/claude-code/overview">Claude Code</a> on your laptop. If not, do the <a href="/academy/workstation-tutorial-1-wat-installeer-je">Workstation Setup tutorial series</a> first.</PrerequisiteItem>
