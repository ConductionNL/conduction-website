...
This part deepens the *manifest* surface. [Part 6: Integrate](/academy/build-an-app-tutorial-6-integrate) widens the app to *other systems* (cross-register reads, Integriq sources, webhooks). Both build directly on Part 4. Take them in either order, or pick whichever your next app needs first.
:::
...
<NextSteps>
  <NextStep
    ...
    description="Connect your app to the rest of the workspace. Cross-register reads, Integriq sources, and a two-way webhook sync: three integration patterns layered from least to most invasive."
  />
  <NextStep
