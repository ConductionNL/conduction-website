...
<table className="editorial-table">
  ...
  <tbody>
    ...
    <tr><td>Solutions <span style={{color: 'var(--c-cobalt-400)'}}>· Learniq, OpenProject, XWiki, GitLab</span></td><td>Apps governments need out of the box, integrated as first-class citizens of the workspace.</td></tr>
    ...
    <tr><td>App builder <span style={{color: 'var(--c-cobalt-400)'}}>· Buildiq</span></td><td>Composition layer for citizen-developers and organisations. Fork-free customisation.</td></tr>
  </tbody>
</table>
