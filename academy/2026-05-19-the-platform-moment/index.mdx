...
tags: [Nextcloud, Platform, Sovereignty, AI, OpenBuild]
durationMinutes: 10
---
...
<table className="editorial-table">
  ...
  <tbody>
    ...
    <tr><td>App builder <span style={{color: 'var(--c-cobalt-400)'}}>· OpenBuild</span></td><td>Composition layer for citizen-developers and organisations. Fork-free customisation.</td></tr>
  </tbody>
</table>
...
<section className="setup-steps">
  ...
  <div className="step-row">
    ...
    <div className="body">
      ...
      <p>Whether through OpenBuild or a comparable initiative. Without a citizen-developer on-ramp, a platform is not a platform.</p>
    </div>
  </div>
  <div className="step-row">
