...
<Prerequisites title="Where you should be">
  ...
  <PrerequisiteItem>The local clone of <a href="https://github.com/ConductionNL/petstore">ConductionNL/petstore</a> on your filesystem and a working <code>npm run build</code>.</PrerequisiteItem>
</Prerequisites>
...
The full file ships in [the petstore repo](https://github.com/ConductionNL/petstore/blob/main/lib/Settings/petstore_register.json), with five seed pets, three categories (Dogs, Cats, Fish), and three orders so the app is browsable on first install.
