...
title: "OpenSpec tutorial series — Part 3 (optional): Retrofit an existing codebase"
...
<Prerequisites title="What you'll need">
  <PrerequisiteItem>Part 1 — <a href="/academy/openspec-tutorial-1-wat-is-openspec">What is OpenSpec?</a> — for the spec / requirement / scenario / change vocabulary.</PrerequisiteItem>
  <PrerequisiteItem>Part 2 — <a href="/academy/openspec-tutorial-2-eerste-change">Your first OpenSpec change</a> — so the <code>/opsx-*</code> command shape isn't new to you.</PrerequisiteItem>
