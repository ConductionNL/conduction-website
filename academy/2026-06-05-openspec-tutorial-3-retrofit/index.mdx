...
title: "OpenSpec tutorial series — Part 3: Retrofit an existing codebase"
contentType: tutorial
authors: [conduction]
date: 2026-06-05
summary: How to bring an app that predates OpenSpec under the spec ↔ code annotation convention. Audit with /opsx-coverage-scan, annotate Bucket 1 with /opsx-annotate, draft missing requirements with /opsx-reverse-spec. Third part of the OpenSpec series.
...
In Part 1 and Part 2 you wrote a brand-new change in a project that was already spec-first. In real life most of our apps **predate** OpenSpec — they have working code, but no `openspec/specs/`, and certainly no `@spec` tags pointing from code to a requirement. This third part is about **closing that gap**: bringing an existing app under the OpenSpec convention with three retrofit skills. We work through the [retrofit playbook](https://codeberg.org/Conduction/.github/src/branch/main/docs/claude/retrofit.md) end to end.
