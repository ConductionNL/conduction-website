...
> **Why Node 20, not the latest?** Docusaurus 3.x and the OpenSpec CLI both want Node 20+, and our canonical [workstation-setup.md](https://github.com/ConductionNL/.github/blob/main/docs/claude/workstation-setup.md) installs Node 20 specifically. Stick to 20 LTS until you have a reason not to.
...
This is the condensed walkthrough. The full version, with every troubleshooting case and a deeper rationale, lives in [Codeberg Authentication Setup](https://github.com/ConductionNL/.github/blob/main/docs/claude/codeberg-auth-setup.md) in the `.github` repo. Read that if anything below misbehaves.
