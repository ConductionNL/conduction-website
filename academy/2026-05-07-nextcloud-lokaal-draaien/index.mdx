...
<NextSteps title="Volgende stap" lede="Een werkende Nextcloud is de aanleiding voor de andere tutorials in deze serie.">
  <NextStep
    title="Een Woo-register opzetten"
    href="/academy/woo-register-opzetten"
    description="Importeer het canonieke Woo-register in OpenRegister."
  />
  <NextStep
    title="Bestanden uploaden bij een Woo-publicatie"
    href="/academy/woo-bestanden-uploaden"
    description="Vier upload-modes voor documenten."
  />
  <NextStep
    title="Build je eerste Conduction-app"
    href="/academy/build-an-app"
    description="Eindigt met een geïnstalleerde app op deze stack."
  />
</NextSteps>
