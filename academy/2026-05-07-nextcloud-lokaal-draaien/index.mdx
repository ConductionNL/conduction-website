...
> **Day-to-day developer setup?** If you're working through the [Conduction Workstation Setup tutorial chain](/academy/workstation-tutorial-1-wat-installeer-je), [Part 5](/academy/workstation-tutorial-5-nextcloud-lokaal) picks up where this tutorial leaves off — covering the Conduction `apps-extra` workspace flow (Docker profiles, `clean-env.sh`, reset-or-keep state) that the standalone compose below doesn't have.
