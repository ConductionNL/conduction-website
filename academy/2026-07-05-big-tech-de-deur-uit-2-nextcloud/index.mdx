...
title: "Kicking Big Tech to the curb: Nextcloud for home use, away from Microsoft 365 and Google"
contentType: blog
heroIcon: homeServer
authors: [robert]
date: 2026-07-05
...
The password manager I use is, for now, just about good enough for my personal Nextcloud, but it doesn't have the security and power I'd want. The good news: we at Conduction are already working on this. The app Keepiq fills exactly the gaps my current app still has.
