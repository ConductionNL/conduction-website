...
- **Aannames vooraf opdrogen.** Wat lijkt op één feature blijkt vaak vier features tegelijk. Scenario's schrijven brengt gaten en tegenstrijdigheden naar boven vóór de code in plaats van erna in een PR-review.
...
- **Exploratief prototype** — als je nog niet weet of het idee überhaupt werkt. Eerst een vieze proof-of-concept om aannames te toetsen, sloop hem weg, en schrijf daarna pas de spec voor de versie die écht in productie gaat.
