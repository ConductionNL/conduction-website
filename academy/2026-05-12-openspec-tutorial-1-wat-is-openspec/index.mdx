...
<Prerequisites title="What you'll need">
  ...
  <PrerequisiteItem>A working dev machine. Don't have one yet? Start with the <a href="/academy/workstation-tutorial-1-wat-installeer-je">Workstation Setup tutorial series</a> (six short modules, one evening).</PrerequisiteItem>
