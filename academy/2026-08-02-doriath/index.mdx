---
slug: doriath
title: "Doriath: a zero-knowledge secrets vault inside Nextcloud"
contentType: webinar
heroIcon: vault
authors: [conduction]
date: 2026-08-02
summary: A walk-through of Doriath, the encrypted secrets manager for Nextcloud. Personal vaults, team sharing, and a write-without-read credential store for applications — all backed by a private Certificate Authority your instance bootstraps and manages itself.
tags: [Doriath, Secrets, Encryption, Security, Nextcloud]
apps: [doriath]
durationMinutes: 40
---
...
<NextSteps>
  <NextStep
    title="Doriath on the app page"
    href="/apps/doriath"
    description="What the app does, who it is for, and the apps it pairs with. Doriath is in public beta — install from source while it finishes."
  />
  <NextStep
...
- Source and issues: [Doriath on Codeberg](https://codeberg.org/Conduction/doriath)
