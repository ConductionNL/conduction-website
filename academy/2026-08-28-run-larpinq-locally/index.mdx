...
<Outcomes>
  ...
  <Outcome>Transparent stat audit trail.</Outcome>
  <Outcome>Character sheets that recompute themselves.</Outcome>
  <Outcome>Rules the system enforces for you.</Outcome>
