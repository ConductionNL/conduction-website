...
Both registers are published as OpenRegister configuration files, hosted on the [OpenRegister downloads page](https://openregister.conduction.nl/downloads). You do not edit them; you point OpenRegister at the URL and it does the rest.

| Register | Configuration URL |
| --- | --- |
| Woo | `https://openregister.conduction.nl/oas/woo_register.json` |
| DCAT | `https://openregister.conduction.nl/oas/dcat_register.json` |
...
Repeat Step 1 with the DCAT configuration URL. Open **Import Configuration → Import from URL**, paste `https://openregister.conduction.nl/oas/dcat_register.json`, and click **Import**.
