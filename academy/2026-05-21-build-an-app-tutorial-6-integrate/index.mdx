...
<NextSteps>
  ...
  <NextStep
    ...
    href="https://github.com/ConductionNL/petstore"
    description="The reference app may need to be created on GitHub first. Yours is the journey: change the schemas, rename the menu, swap the external system. The nine-part scaffolding stays the same."
  />
</NextSteps>
