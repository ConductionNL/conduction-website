...
<NextSteps title="Next step" lede="Your first change is in. A few logical follow-ups:">
  <NextStep
    title="Part 3 — Retrofit an existing codebase"
    href="/academy/openspec-tutorial-3-retrofit"
    description="Take the OpenSpec convention to an app that predates it: audit with /opsx-coverage-scan, annotate Bucket 1, draft missing REQs with /opsx-reverse-spec."
  />
  <NextStep
