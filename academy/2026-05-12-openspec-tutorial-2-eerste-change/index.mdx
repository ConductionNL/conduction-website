...
<Prerequisites title="What you'll need">
  ...
  <PrerequisiteItem>Claude Code installed and working in your project folder. The official <a href="https://docs.claude.com/en/docs/claude-code/quickstart">Claude Code quickstart</a> gets you set up in five minutes.</PrerequisiteItem>
