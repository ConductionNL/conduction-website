...
<Prerequisites title="What you'll need">
  ...
  <PrerequisiteItem>Claude Code installed and working in your project folder. If you don't have that yet, start with the <a href="/academy/workstation-tutorial-1-wat-installeer-je">Workstation Setup tutorial series</a> — Part 3 wires up Claude Code with the mandatory safety hooks.</PrerequisiteItem>
...
<NextSteps title="Next step" lede="Your first change is in. A few logical follow-ups:">
  <NextStep
    title="Part 3 (optional) — Retrofit an existing codebase"
    href="/academy/openspec-tutorial-3-retrofit"
    description="Only if you've been asked to bring an older app under the current OpenSpec convention. Reference playbook for /opsx-coverage-scan, /opsx-annotate and /opsx-reverse-spec — talk to your team lead first."
  />
  <NextStep
