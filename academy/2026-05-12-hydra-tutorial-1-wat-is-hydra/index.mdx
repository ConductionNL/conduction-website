...
<Prerequisites title="What you need">
  ...
  <PrerequisiteItem>Only needed if you want to run Hydra yourself (rather than just read the series): access to the private <a href="https://codeberg.org/Conduction/hydra">ConductionNL/hydra</a> repo. Ask your team lead.</PrerequisiteItem>
</Prerequisites>
