...
<Prerequisites title="Where you should be">
  ...
  <PrerequisiteItem>The local clone of <a href="https://codeberg.org/Conduction/deskdesk">Conduction/deskdesk</a> on your filesystem and a working <code>npm run build</code>.</PrerequisiteItem>
</Prerequisites>
