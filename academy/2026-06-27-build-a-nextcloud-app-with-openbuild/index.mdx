...
<figure>
  ...
  <figcaption>The schema editor (edit menu → Edit data… → a schema): add and type each property on the Properties tab, set composition and relations on Configuration, and group access on Security — no code.</figcaption>
</figure>
